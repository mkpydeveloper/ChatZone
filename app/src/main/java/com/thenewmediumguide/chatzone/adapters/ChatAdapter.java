package com.thenewmediumguide.chatzone.adapters;
...
import com.thenewmediumguide.chatzone.databinding.ItemContainerRecievedMessageBinding;
import com.thenewmediumguide.chatzone.databinding.ItemContainerSentMessageBinding;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_SENT){
            return new SentMessageViewHolder(
                    ItemContainerSentMessageBinding.inflate(LayoutInflater
            ...
            return  new ReceivedMessageViewHolder(
                    ItemContainerRecievedMessageBinding.inflate(LayoutInflater.from(
                            parent.getContext()
                    ),parent, false)
            );
        }
